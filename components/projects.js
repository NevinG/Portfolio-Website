const projects = [
    ...
    {
        projectName: "Nevin.fun (11 Games)",
        projectType: "Web Dev",
        projectHTML: `
        <div class="project" id="current-project">
            <h1 class="project-title">Nevin.fun (11 Games)</h1>
            <div style="display: flex;">
                <div class="project-technology"style="margin-left: 0;">HTML</div>
                <div class="project-technology">CSS</div>
                <div class="project-technology">JavaScript</div>
            ...
            <p class="project-text">
                ...
                <br> 
                <span>Week #6 (02/04-02/10): Circle Game - </span>
                <a target="_blank" class="link_to_new_tab" href="https://nevin.fun/circle-game/"><u>View Project</u></a>

                <br> 
                <span>Week #7 (02/11-02/17): Reaction Speed Test - </span>
                <a target="_blank" class="link_to_new_tab" href="https://nevin.fun/reaction-speed-test/"><u>View Project</u></a>
                ...
                <br> 
                <span>Week #11 (03/10-03/16): Shape Slicer- </span>
                <a target="_blank" class="link_to_new_tab" href="https://nevin.fun/shape-slicer/"><u>View Project</u></a>
            </p>
        </div>
        `
    },
    {
        projectName: "NBA Game Predictor",
        projectType: "Fullstack AI/ML",
        projectHTML: `
        <div class="project" id="current-project">
    ...
    {
        projectName: "Coding Typing Test",
        projectType: "Web Dev",
        projectHTML: `
        <div class="project" id="current-project">
    ...
    {
        projectName: "Ishihara Plate Generator",
        projectType: "Web Dev",
        projectHTML: `
        <div class="project" id="current-project">
